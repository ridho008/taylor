...
$query = query("SELECT * FROM nota INNER JOIN user ON nota.id_user = user.id_user INNER JOIN barang ON barang.id_barang = nota.id_barang");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
   <h2 align="center">Daftar Nota</h2>
      ...
      <tbody>
         ...
         ?>
            <tr>
               ...
               <td><?= $k['banyaknya'] ?></td>
               <td>
                  <a href="edit.php?id=<?= $k['id_nota']; ?>">Edit</a>
